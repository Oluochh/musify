        ...
        <div class="contact-holder">
          ...
          <form @submit.prevent="sendMsg" class="contact-f">
            <div class="input-wrapper">
              <input type="text" placeholder="Penguin" class="contact-input" v-model="username" required>
              <input type="email" placeholder="Penguin@gmail.com" class="contact-input" v-model="email" required>
            </div>
